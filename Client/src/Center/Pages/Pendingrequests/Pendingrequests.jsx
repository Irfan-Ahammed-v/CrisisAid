...
const PendingRequests = () => {
  ...
  const loadSampleData = () => {
    ...
    const sampleVolunteers = [
      ...
      },
      {
        ...
        availability: "busy",
        skills: ["Emergency Response", "Rescue Operations"],
      ...
      },
      {
        ...
        availability: "available",
        skills: ["Construction", "Shelter Setup"],
        assigned_task: null
      }
    ];
  ...
  const handleAccept = (requestId) => {
    ...
    setRequests(prev => prev.map(req => 
      req._id === requestId ? { ...req, request_status: "accepted" } : req
    ));
  };
  ...
  const handleReject = (requestId) => {
    ...
    setRequests(prev => prev.map(req => 
      req._id === requestId ? { ...req, request_status: "rejected" } : req
    ));
  };
                  ...
                  <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-4">
                    ...
                    <div className="flex flex-col items-end gap-2">
                      ...
                      <div className="text-xs text-slate-600">
                        <span className="font-semibold">Contact:</span> {request.contact_person}
                      </div>
                      <div className="text-xs text-slate-600">{request.contact_phone}</div>
                    </div>
                  </div>
                </div>
            ...
            <div className="p-6">
              ...
              <div className="mb-6">
                ...
                <textarea
                  ...
                  placeholder="Add any instructions or notes for the camp..."
                  rows={3}
