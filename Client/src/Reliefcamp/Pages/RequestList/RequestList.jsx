...
const RequestList = () => {
  ...
  const getStatusIcon = (status) => {
    const icons = {
      ...
      in_review: <VisibilityIcon sx={{ width: 24, height: 24, color: "#303992" }} />,
      approved: <CheckCircleOutlineTwoToneIcon sx={{ width: 24, height: 24, color: "#16a34a" }} />,
  ...
  const stats = {
    ...
    approved: requests.filter((r) => r.request_status.toLowerCase() === "approved").length,
                  ...
                  <div className="p-6">
                    <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-4 mb-4">
                      ...
                      <div className="flex flex-wrap gap-2">
                        ...
                        <span
                          className={`px-4 py-2 text-sm font-semibold rounded-lg border ${priorityBadge.bg} ${priorityBadge.color} border-${req.request_priority}-200`}
                        >
